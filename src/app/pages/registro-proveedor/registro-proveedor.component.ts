...
export class RegistroProveedorComponent implements OnInit {
    ...
    guardarProveedor() {
        ...
        console.log( this.proveedor.prFechaInicioCertificado );
        console.log( this.proveedor.prFechaFinCertificado );
        console.log( this.proveedor.prFechaInicioFormulario );
        console.log( this.proveedor.prFechaFinFormulario );
        this.setearValores();
    ...
    verificarPais() {
        this.catalogoService.buscarCatalogoPorId( this.proveedor.idPais ).subscribe( res => {
            ...
            if ( this.pais.cpCodigoCatalogo === 'ECUADOR' ) {
                ...
                if ( this.proveedor.prFechaInicioCertificado != null ) {
                    this.model.fechaInicioCertificado = new Date( this.proveedor.prFechaInicioCertificado );
                    this.model.fechaFinCertificado = new Date( this.proveedor.prFechaFinCertificado );
                    this.model.fechaInicioFormulario = new Date( this.proveedor.prFechaInicioFormulario );
                    this.model.fechaFinFormulario = new Date( this.proveedor.prFechaFinFormulario );
                }
            }
        },
            err => {
    ...
    setearValores() {
        ...
        if ( this.flagFormularios ) {
            this.proveedor.prFechaInicioCertificado = this.model.fechaInicioCertificado;
            this.proveedor.prFechaFinCertificado = this.model.fechaFinCertificado;
            this.proveedor.prFechaInicioFormulario = this.model.fechaInicioFormulario;
            this.proveedor.prFechaFinFormulario = this.model.fechaFinFormulario;
        }
    }
